...
<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" autocomplete="off">
  ...
  <div class="form-group">
    ...
    <input type="text" name="question_title" class="form-control" id="question_title" placeholder="Title" {{ (Input::old('question_title')) ? ' value="' .e(Input::old('question_title')) . ' "' : ''  }} >
  </div>
  
  <div class="form-group">
    <label for="questionTitle">Category</label>    
    {{ Form::select('category', $category , Input::old('category'), array('id' => 'category', 'class' => 'form-control',  )) }}
  </div> 
  
  <div class="form-group">
    <label for="exampleInputPassword1">Question Details</label>
    <textarea name="question_details" class="form-control" rows="8">{{ (Input::old('question_details')) ? ' value="' .e(Input::old('question_details')) . ' "' : ''  }}</textarea>
  </div>
